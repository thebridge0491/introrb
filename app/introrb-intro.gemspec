...
require_relative 'lib/introrb/intro/version'
...
Gem::Specification.new do |s|
  ...
  s.name = 'introrb-intro'
  s.version = Introrb::Intro::VERSION
  s.summary = 'Main app sub-package for Ruby Intro examples project.'
  s.authors = ['thebridge0491']
  s.files = gemfiles.reject{|f| f.match(%r{^(test|spec)/})}
  
  s.licenses = ['Apache-2.0']
  s.description = 'Main app sub-package for Ruby Intro examples project.'
  ...
  {'logging' => '>= 2.2', 'log4r' => '>= 1.1', 'inifile' => '>= 2.0',
    ...
    'introrb-util' => '>= 0.1', 'introrb-practice' => '>= 0.1'
    }.each do |depn, ver|
