...
configyaml = "name: introrb-intro
summary: Main app sub-package for Ruby Intro examples project.
description: Main app sub-package for Ruby Intro examples project.
