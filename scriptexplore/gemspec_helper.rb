...
configyaml = "name: introrb-scriptexplore
summary: Script explore sub-package for Ruby Intro examples project.
description: Script explore sub-package for Ruby Intro examples project.
