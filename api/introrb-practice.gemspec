...
Gem::Specification.new do |s|
  ...
  s.name = 'introrb-practice'
  s.version = Introrb::Practice::VERSION
  s.summary = 'Practice sub-package for Ruby Intro examples project.'
  s.authors = ['thebridge0491']
  s.files = gemfiles.reject{|f| f.match(%r{^(test|spec)/})}
  
  s.licenses = ['Apache-2.0']
  s.description = 'Practice sub-package for Ruby Intro examples project.'
