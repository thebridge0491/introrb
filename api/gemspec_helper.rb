...
configyaml = "name: introrb-practice
summary: Practice sub-package for Ruby Intro examples project.
description: Practice sub-package for Ruby Intro examples project.
...
SPEC = 
  if 'jeweler' == choosehelper
    ...
    require_relative 'lib/introrb/practice/version'
    ...
    Jeweler::Tasks.new do |s|
      ...
      s.version = Introrb::Practice::VERSION
